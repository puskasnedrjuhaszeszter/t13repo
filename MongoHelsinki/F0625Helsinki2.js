...
eredmenyek = [
  ...
  function ObjektumFeltolto(feltoltendoElem) {
    ...
    for (let i = 0; i < feltoltendoElem.length; i++) {
      ...
      objektum.Helyezes = Number(daraboltAdatSor[0]);
      objektum.CsapatMeret = Number(daraboltAdatSor[1]);
      objektum.Sportag = daraboltAdatSor[2];
      objektum.VersenySzam = daraboltAdatSor[3];
      beolvasottAdatok.push(objektum);
    }
    return beolvasottAdatok;
  }
  
  async function kollekcioFeltoltes() {
    try {
