...
const Eredmenyek = ObjektumFeltolto(eredmenyek);
//3. feladat
function Real_kereso(vizsgaltTomb) {
    let hazai_real = 0;
    let idegen_real = 0;
...
//4. feladat
function dontetlen_kereso(vizsgaltTomb) {
    for (let i = 0; i < vizsgaltTomb.length; i++) {
...
function dontetlen_kiirato(eredmeny) {
    if (eredmeny == true) {
...
//5. feladat
function barcelona_kereso(vizsgaltTomb) {
    let keresett_csapat = "";
    for (let i = 0; i < vizsgaltTomb.length; i++) {
...
function barcelona_kiirato(eredmeny) {
...
function November2004Kiirato(eredmeny) {
...
function stadionok(vizsgaltObjektum) {
    ...
    for (let i = 0; i < vizsgaltObjektum.length; i++) {
        let szerepelE = false;
        for (let j = 0; j < stadionok.length; j++) {
...
function merkozesekMennyisege(vizsgaltObjektum, stadionok) {
    let merkozesekMennyisege = [];
...
function stadionStatisztikaKiir(eredmenyTomb, mennyisegTomb) {
    console.log("7. feladat");
    for (let i = 0; i < mennyisegTomb.length; i++) {
